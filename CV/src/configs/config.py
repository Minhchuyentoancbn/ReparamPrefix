...
_C.MODEL.PROMPT.PREFIX_TUNING = False  # if true, use prefix tuning for prompt
_C.MODEL.PROMPT.SHARE_KV = False  # if true, share the key and value for prompt
_C.MODEL.PROMPT.SHARE_TYPE = "non-linear"  # "linear" or "non-linear"
_C.MODEL.PROMPT.KV_ONLY = False  # if true, only use key and value for prompt tuning only
